...
public class LoanBundleer {
	...
	public static Bundle makeLoanInfoBundle(double loanAmount,
		...
		loanInfo.putLong("loanPeriodInMonth", loanPeriodInMonths);
	...
	public static Bundle makeLoanInfoBundle(double loanAmount,
		...
		return (makeLoanInfoBundle(loanAmount, 
	...
	public static Bundle makeRandomizedLoanInfoBundle(){
        ...
        return(LoanBundleer.makeLoanInfoBundle(loanAmount, 
